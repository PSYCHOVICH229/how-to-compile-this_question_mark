...
class Prompt extends MusicBeatSubstate
{
	...
	private inline function makeSelectorGraphic(panel:FlxSprite, w, h, color:FlxColor)
	{
	...
	private inline function drawCircleCornerOnSelector(panel:FlxSprite, flipX:Bool, flipY:Bool, color:FlxColor)
	{
