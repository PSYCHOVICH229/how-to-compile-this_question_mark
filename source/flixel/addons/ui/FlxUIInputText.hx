...
class FlxUIInputText extends FlxInputText implements IResizable implements IFlxUIWidget implements IHasParams
{
	...
	public inline static final CHANGE_EVENT:String = "change_input_text"; // change in any way
	public inline static final ENTER_EVENT:String = "enter_input_text"; // hit enter in this text field
	public inline static final DELETE_EVENT:String = "delete_input_text"; // delete text in this text field
	public inline static final INPUT_EVENT:String = "input_input_text"; // input text in this text field
	public inline static final COPY_EVENT:String = "copy_input_text"; // copy text in this text field
	public inline static final PASTE_EVENT:String = "paste_input_text"; // paste text in this text field
	public inline static final CUT_EVENT:String = "cut_input_text"; // cut text in this text field
