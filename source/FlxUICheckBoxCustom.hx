...
class FlxUICheckBoxCustom extends FlxUIGroup implements ILabeled implements IFlxUIClickable implements IHasParams implements ICursorPointable
{
	...
	public inline static final CLICK_EVENT:String = "click_check_box";
	...
	public function new(X:Float = 0, Y:Float = 0, ?Box:Dynamic, ?Check:Dynamic, ?Label:String, ?LabelSize:Int = 8, ?LabelW:Int = 100, ?Font:String,
			?Params:Array<Dynamic>, ?Callback:Void->Void)
	{
		super();
